...
void Application::Initialize(CoreApplicationView^ applicationView)
{
...
void Application::SetWindow(CoreWindow^ window)
{
	...
	currentDisplayInformation->DpiChanged +=
		ref new TypedEventHandler<DisplayInformation^, Object^>(this, &Application::OnDpiChanged);

	currentDisplayInformation->OrientationChanged +=
		ref new TypedEventHandler<DisplayInformation^, Object^>(this, &Application::OnOrientationChanged);

	DisplayInformation::DisplayContentsInvalidated +=
		ref new TypedEventHandler<DisplayInformation^, Object^>(this, &Application::OnDisplayContentsInvalidated);
...
void Application::OnActivated(CoreApplicationView^ applicationView, IActivatedEventArgs^ args)
{
...
void Application::OnResuming(Platform::Object^ sender, Platform::Object^ args)
{
...
void Application::OnWindowClosed(CoreWindow^ sender, CoreWindowEventArgs^ args)
{
	m_windowClosed = true;
}
...
void Application::OnDpiChanged(DisplayInformation^ sender, Object^ args)
{
...
void Application::OnOrientationChanged(DisplayInformation^ sender, Object^ args)
{
	m_deviceResources->SetCurrentOrientation(sender->CurrentOrientation);
	m_main->CreateWindowSizeDependentResources();
}

void Application::OnDisplayContentsInvalidated(DisplayInformation^ sender, Object^ args)
{
